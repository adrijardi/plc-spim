...
// Wed Apr 01 17:59:54 CEST 2009
//----------------------------------------------------

import java_cup.runtime.*;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Apr 01 17:59:54 CEST 2009
  */
...
class CUP$Syntactic$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Syntactic$do_action(
	...
	nodo.addRightHijo((NodeAnalyzer)ts);
 	switch (nadd.getNodeType()) {
	case VAR:
		nodo.addRightHijo(nadd);
		break;
	case ARRAYVAR:
		nodo.addRightHijo(nadd);
		break;
	...
	default:
		parser.addError("Incorrecta declaracion de parametro.");
		nodo.setError(true);
		break;
	}
